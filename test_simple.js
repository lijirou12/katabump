...
(async () => {
    console.log('\n===========================================');
    console.log('  Katabump Turnstile 简化测试脚本');
    console.log('===========================================\n');

    try {
        console.log('[TEST] Launching Playwright Chromium...');
        ...
        console.log('[TEST] Test completed. Browser will remain open for 60 seconds.');
